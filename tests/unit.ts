...
describe('Builder', function() {
  describe('constructor', function() {
    it('should assign driver to this._frame', function() {
      assert.equal(new Builder('bob')._frame, 'bob')
    })
    ...
    it('should define this._options as null', function() {
      assert.isNull(newEmptyBuilder()._options)
    })

    it('should define this._config as null', function() {
      assert.isNull(newEmptyBuilder()._config)
    })
  })
  ...
  describe('options', function() {
    ...
    it('should return itself', function() {
      assert.instanceOf(newEmptyBuilder().options('bob'), Builder)
    })
  })
